...
export default function About() {
	return (
		...
		<p>&emsp;I believe creativity is a lifestyle. I also believe everything I do ought to be done well and with intention. 
			Using contemporary tools and practices, I produce web applications that dissolve the boundaries between art and design.</p>
		<p>&emsp;I’ve studied engineering, archaeology, history, and oil painting. I’ve worked a diverse assortment of jobs, 
		...
		<p>&emsp;I grew up surrounded by computers, an effect of my father’s career in information technology. 
			...
			has never faded.</p>
		<p>&emsp;It is web development in particular which fascinates me because of its unprecedented potential to transcend barriers 
